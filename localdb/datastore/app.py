...
from datastore.configs import settings, configurations
from datastore.utils.filehandler import FilePreprocess
from datastore.CRD.views import CreateData, ReadData, DeleteData
from argparse import ArgumentParser



#CommandLineArguments: --datastore
...
if not directory_created:
    print(f"Permission denied: You can't create the directory `{db_path}`.\n")
    exit(0)
